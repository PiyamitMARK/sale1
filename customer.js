...
const PRODUCTS = {
  setkao: [
    ...
    { id:'setkao4', name:'ข้าวซอยหมูทอด + โค๊ก',      price:65, img:IMG(10020),   productType:'setkao' },
    { id:'setkao5', name:'ข้าวซอยหมูทอด + ชาไทย',       price:90, img:IMG(10019),  productType:'setkao' },
    { id:'setkao6', name:'ข้าวซอยหมูทอด + มะพร้าวปั่น',            price:95, img:IMG(10018),   productType:'setkao' },
